...
그래서 우리는 [GitHub][GitHub] 같은 remote storage(원격 저장소)를 이용해 백업을 해야한다.

![text](/assets/loginGitHub.png)

아직, [GitHub][GitHub]에 가입 하지 않았다면 회원가입을 하자.

---

![text](/assets/setGitHub.png)

**+**를 누르게 되면 **New repository**가 보인다. 프로젝트를 올릴 때 자주 가게 될 녀석이다.

---

![text](/assets/createGitHub.png)
...
![text](/assets/HttpsOrSshGitHub.png)
...
![text](/assets/sshSetGitHub.png)

들어가게 되면 이런 창이 나오는데, 혹시 SSH Key를 어디서 확인하는지 모르는 경우 [여기][여기]를 클릭해 진행하면 될 것이다.
...
[여기]: https://help.github.com/en/github/authenticating-to-github/connecting-to-github-with-ssh